<template>
  ...
  <p v-for="(podcast, index) in podcastList" :key="index" :value="podcast.id">
    <a :href="podcast.url" style="font-size: large;">{{podcast.title}}</a> ({{ podcast.lengthInMinutes}} minuter)<br>
